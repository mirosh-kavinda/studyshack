            ...
            <div class="carousel-item active">
              ...
              <div class="col-md-4">
                ...
                <div class="testimonial">
                  ...
                  <div class="avatar mx-auto mb-4">
                    <img src="img/persons/p1.jpg" class="rounded-circle img-fluid">
                  </div>
                  <!--Content-->
                  <h4 class="font-weight-bold">Anna Deynah</h4>

                  <p>
                    <i class="fas fa-quote-left"></i> Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Quod
                    eos id officiis
                    hic tenetur.
                  </p>
              ...
              <div class="col-md-4 clearfix d-none d-sm-block">
                <div class="testimonial">
                  <!--Avatar-->
                  <div class="avatar mx-auto mb-4">
                    <img src="img/persons/p2.jpg" class="rounded-circle img-fluid">
                  </div>
                  <!--Content-->
              ...
              <div class="col-md-4 clearfix d-none d-sm-block">
                <div class="testimonial">
                  <!--Avatar-->
                  <div class="avatar mx-auto mb-4">
                    <img src="img/persons/p3.jpg" class="rounded-circle img-fluid">
                  </div>
                  <!--Content-->
                  <h4 class="font-weight-bold">Abbey Clark</h4>

                  <p>
                    <i class="fas fa-quote-left"></i> Quis autem vel eum iure reprehenderit qui in ea voluptate
                    velit
                    esse quam
                    nihil molestiae.
                  </p>
            ...
            <div class="carousel-item">
              ...
              <div class="col-md-4">
                ...
                <div class="testimonial">
                  <!--Avatar-->
                  <div class="avatar mx-auto mb-4">
                    <img src="img/persons/p4.jpg" class="rounded-circle img-fluid">
                  </div>
                  <!--Content-->
              ...
              <div class="col-md-4 clearfix d-none d-sm-block">
                <div class="testimonial">
                  <!--Avatar-->
                  <div class="avatar mx-auto mb-4">
                    <img src="img/persons/p5.jpg" class="rounded-circle img-fluid">
                  </div>
                  <!--Content-->
              ...
              <div class="col-md-4 clearfix d-none d-sm-block">
                <div class="testimonial">
                  <!--Avatar-->
                  <div class="avatar mx-auto mb-4">
                    <img src="img/persons/p6.jpg" class="rounded-circle img-fluid">
                  </div>
                  <!--Content-->
                  <h4 class="font-weight-bold">Cami Gosse</h4>

                  <p>
                    <i class="fas fa-quote-left"></i> At vero eos et accusamus et iusto odio dignissimos ducimus
                    qui
                    blanditiis
                    praesentium.
                  </p>
            ...
            <div class="carousel-item">
              ...
              <div class="col-md-4">
                ...
                <div class="testimonial">
                  <!--Avatar-->
                  <div class="avatar mx-auto mb-4">
                    <img src="img/persons/p7.jpg" class="rounded-circle img-fluid">
                  </div>
                  <!--Content-->
              ...
              <div class="col-md-4 clearfix d-none d-sm-block">
                <div class="testimonial">
                  <!--Avatar-->
                  <div class="avatar mx-auto mb-4">
                    <img src="img/persons/p8.jpg" class="rounded-circle img-fluid">
                  </div>
                  <!--Content-->
              ...
              <div class="col-md-4 clearfix d-none d-sm-block">
                <div class="testimonial">
                  <!--Avatar-->
                  <div class="avatar mx-auto mb-4">
                    <img src="img/persons/p9.jpg" class="rounded-circle img-fluid">
                  </div>
                  <!--Content-->
...
<footer class="page-footer text-center text-md-left mdb-color darken-3 ">
    ...
    <div class="container mb-1 mt-1 ">
      ...
      <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 pt-1 pb-1">
          <!--About-->
          <h5 class="text-uppercase mb-3 font-weight-bold">ABOUT Study Shack</h5>
        ...
        <div class="col-xl-3 ml-lg-auto col-lg-4 col-md-6 mt-1 mb-1">
          ...
          <p>
            <i class="fas fa-envelope pr-1"></i> studyshack@gmail.com
          </p>
          <p>
  ...
  <div class="footer-copyright py-3 text-center">
    <div class="container-fluid">
      © 2023 Copyright: <a href="https://mirosh.me" target="_blank"> Mirosh.me </a>
    </div>
  </div>
</footer>
