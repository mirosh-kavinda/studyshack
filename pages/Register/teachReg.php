<form action="../../utils/authenticate.php" method="post" class="mb-5 ">
    ...
    <div class="row">
        <div class="col-md-12 ">
            ...
            <table class="table align-middle">
                <tr>
                    <td> Grade 1 <input required type="checkbox" name="grade[]" value="1"></td>
                    <td> Grade 2 <input required type="checkbox" name="grade[]" value="2" /></td>
                    <td> Grade 3 <input required type="checkbox" name="grade[]" value="3" /></td>
                    <td> Grade 4 <input required type="checkbox" name="grade[]" value="4" /></td>
                </tr>
                <tr>
                    <td> Grade 5 <input required type="checkbox" name="grade[]" value="5" /></td>
                    <td> Grade 6 <input required type="checkbox" name="grade[]" value="6" /></td>
                    <td> Grade 7 <input required type="checkbox" name="grade[]" value="7" /></td>
                    <td>Grade 8 <input required type="checkbox" name="grade[]" value="8" /></td>
                </tr>
                <tr>
                    <td> Grade 9 <input required type="checkbox" name="grade[]" value="9" /></td>
                    <td>Grade 10 <input required type="checkbox" name="grade[]" value="10" /></td>
                    <td> Grade 11 <input required type="checkbox" name="grade[]" value="11" /></td>
                    <td> Grade 12 <input required type="checkbox" name="grade[]" value="12" /></td>
                </tr>
                <tr>
                    <td>Grade 13 <input required type="checkbox" name="grade[]" value="13" /></td>
                </tr>
            </table>
            </select>
        ...
        <div class="d-flex justify-content-end ">
            ...
            <input required type="submit" name="tregister" class="btn btn-info btn-lg ms-2" value="Submit" />
        </div>
</form>