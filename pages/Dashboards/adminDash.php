...
<body>
  ...
  <div class="row d-flex justify-content-center align-items-center h-100 ">
    <div class="card p-4">
      ...
      <h3 class="mb-5 p-3 text-uppercase">Admin Dashboard</h3>
      <div class="row w-100">
        ...
        <div class="col-2">
          ...
          <div class="nav flex-column nav-tabs text-center" id="v-tabs-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" id="v-tabs-profile-tab" data-mdb-toggle="tab" href="#v-tabs-profile" role="tab" aria-controls="v-tabs-profile" aria-selected="false">Create Class</a>
        ...
        <div class="col-9">
          ...
          <div class="tab-content" id="v-tabs-tabContent">
            ...
            <div class="tab-pane fade" id="v-tabs-profile" role="tabpanel" aria-labelledby="v-tabs-profile-tab">
              <?php
              include("../../pages/Register/classReg.php"); ?>
            </div>
