  ...
  <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
    ...
    <form action="index.php" class="border-dark  " method="Post">
      ...
      <div class="form-outline mt-2 ">
        <input type="email" id="form3Example3" class="form-control form-control-lg border-dark" placeholder="Enter a valid email address" name="username" />
        <label class="form-label" for="form3Example3">Email address</label>
      </div>

      <!-- Password input -->
      <div class="form-outline mb-3">
        <input type="password" id="form3Example4" class="form-control form-control-lg border-dark" placeholder="Enter password" name="password" />
